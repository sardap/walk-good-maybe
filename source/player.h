...
#define PLAYER_AIR_START_SLOWDOWN (2.0f * FIX_SCALEF)
#define PLAYER_AIR_SLOWDOWN_MIN (1.0f * FIX_SCALEF)

#define PLAYER_START_JUMP_POWER (2.0f * FIX_SCALEF)
#define PLAYER_MAX_JUMP_POWER (3.0f * FIX_SCALEF)
...
#define PLAYER_ADD_JUMP_STEP (0.1f * FIX_SCALEF)
